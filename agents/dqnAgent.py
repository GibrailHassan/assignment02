...
class DQNAgent(AbstractAgent):
    ...
    def __init__(self, state_shape, action_shape, 
                batch_size=32, learning_rate=0.0005, discount_factor=0.97, epsilon=1.0, epsilon_decay=0.995, epsilon_min=0.0335,
                net_arch=[64, 64], 
        ...
        self.opt = torch.optim.AdamW(self.online_nn.parameters(), lr=self.learning_rate, weight_decay=0.01)
    ...
    def update(self, state, action, reward, next_state, done): 
        ...
        if len(self.memory) >= self.batch_size:
            ...
            with torch.no_grad():
                ...
                y = (rewards.flatten() + self.discount_factor * target_prediction * (1-dones.flatten()))
